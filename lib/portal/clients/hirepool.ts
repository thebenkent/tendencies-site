...
const HIREPOOL: ClientPortalConfig = {
  ...
  visualTokens: {
    ...
    warmSection: '#FFF8F3',
    panel: '#1C1C1C',
    panelElevated: '#252525',
    ink: '#F5F0EC',
    inkMuted: 'rgba(245,240,236,0.58)',
    inkFaint: 'rgba(245,240,236,0.32)',
    border: 'rgba(245,240,236,0.10)',
    imageWell: '#EEE8E4',
    accent: '#F4611C',
    accentSecondary: '#E8A020',
    limeSpot: '#F4611C',
    headerBg: '#0D0D0D',
    warmInk: '#1A0E08',
    warmInkMuted: 'rgba(26,14,8,0.62)',
    warmBorder: 'rgba(26,14,8,0.10)',
    cardOnWarm: '#FFFAF7',
  },
