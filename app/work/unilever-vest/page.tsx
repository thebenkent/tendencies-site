  ...
  return (
    <>
      ...
      <section className="case-section case-hero">
        <div className="case-inner">
          ...
          <h1 className="case-title">
            Unilever<br />
            Brand Vest<span className="case-dot">.</span>
          </h1>

          <p className="case-meta">
            Unilever · Apparel · Multi-Brand Execution
          </p>
        </div>
      </section>
      ...
      <section className="case-section case-block">
        <div className="case-inner case-grid">
          ...
          <div className="case-image">
            <img src="/work/unilever-context.jpg" alt="Unilever brand context" />
          </div>
        </div>
      </section>
      ...
      <section className="case-section case-block">
        <div className="case-inner case-grid">
          <div className="case-image">
            <img src="/work/unilever-design.jpg" alt="Unilever vest branding layout" />
          </div>
      ...
      <section className="case-section case-block">
        <div className="case-inner">
          <div className="case-copy">
            <h3>Product</h3>
            <p>
              Built using durable materials suited to regular wear,
              the vest was designed for real-world conditions — not just
              presentation. Embroidery and print methods were selected
              to maintain brand integrity over time.
            </p>
          </div>

          <div className="case-image case-full">
            <img src="/work/unilever-vest.jpg" alt="Finished Unilever branded vest" />
          </div>
        </div>
      </section>
      ...
      <section className="case-section case-block">
        <div className="case-inner case-grid">
          ...
          <div className="case-image">
            <img src="/work/unilever-usage.jpg" alt="Unilever vest in use" />
          </div>
        </div>
      </section>
